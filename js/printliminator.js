//credits to Chris Coyier of www.css-tricks.com
...
function printlimator() {
	...
	var controls = $('<div>').addClass('_print_controls').css({
	    ...
	    width: 162,
	    height: 182,
	    background: 'url(images/printliminator2.png) no-repeat',
	    zIndex: 10000
	}).mouseover(function () {
	    dont = true
	}).mouseout(function () {
	...
	//Remove Graphics
	$('<div>').css({
		background: 'url(images/printliminator2.png) 0 -182px no-repeat',
		position: 'absolute',
		top: 6,
		left: 6,
		width: 74,
	...
	// Print Stylize
	$('<div>').css({
		background: 'url(images/printliminator2.png) no-repeat -222px -182px',
		position: 'absolute',
		top: 6,
		left: 83,
		width: 74,
	...
	//Print
	$('<div>').css({
		background: 'url(images/printliminator2.png) -74px -182px no-repeat',
		position: 'absolute',
		top: 83,
		left: 83,
		width: 74,
	   ...
	   $(this).css({ "background-position": "-74px -182px" }) 
		...
		var print = $("<link rel='stylesheet' type='text/css' href='css/printliminator.css'/>").appendTo("head");
	...
	//Close
	$('<div>').css({
		background: 'url(images/printliminator2.png) -222px -3px no-repeat',
		position: 'absolute',
		top: -20,
		right: -20,
		width: 33,
    ...
    $("<div>").css({
        background: 'url(images/printliminator2.png) -148px -182px no-repeat',
		position: 'absolute',
		top: 83,
		left: 6,
		width: 74,

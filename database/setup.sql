...
('','CMED','College of Maritime Education'),('','CBM','College of Business Management'),('','LHS','Laboratory High School'),('','<none>','<no department>');
